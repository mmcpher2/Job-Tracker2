...
namespace Job_Tracker2.Controllers
{
    public class JobsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("JobId,Name,CompanyId,ContactId")] Job job)
        {
            ...
            ViewData["ContactId"] = new SelectList(_context.Contact, "ContactId", "Email", job.ContactId);
            return View(job);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("JobId,Name,CompanyId,ContactId")] Job job)
        {
            if (id != job.JobId)
            {
                return NotFound();
